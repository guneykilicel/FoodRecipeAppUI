                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <Text style={{ fontSize: SPACING * 1.7, fontWeight: "800", color: colors.dark }}>Erikaasav</Text>
                        </View>
                        <View style={{
                            flexDirection: "row",
                            alignItems: "center",
                            ...
                            <TouchableOpacity style={{ marginRight: SPACING }}>
                                <Ionicons name='notifications-outline' size={SPACING * 3.5} color={colors.dark} />
                            </TouchableOpacity>
                            <TouchableOpacity>
                    ...
                    <View style={{
                        ...
                        <TextInput placeholder='Want to...' placeholderTextColor={colors.gray} style={{
                            color: colors.gray,
                            fontSize: SPACING * 2,
                            marginLeft: SPACING,
                        }} />
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        {DATA.map((category, index) => (
                            ...
                            onPress= {()=>setActiveCategory(index)}
                                ...
                                activeCategory===index && {color:colors.black, fontWeight:"700",fontSize: SPACING*1.8}
                            ]}
                                >
                                    {category.title}
                                </Text>
                    ...
                    <View style={{flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginVertical: SPACING*2,}}>
                        {DATA[activeCategory].recipes.map(item=>(
                            <TouchableOpacity style={{width: ITEM_WIDTH, marginBottom: SPACING*2}} key={item.id}>
                                ...
                                <Text style={{fontSize: SPACING*1.3, color: colors.gray, marginVertical: SPACING/2,}}>Today discount {item.discount}</Text>
